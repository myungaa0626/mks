...
public class MainEntry { // Object class
	...
	public static void main(String[] args) {
		...
		System.out.println("Object String : " + pt); // 626b2d4a
		System.out.println("Object String : "+pt.toString());
//		System.out.println("10진수 주소 %d\n", 0x626b2d4a );
		System.out.println("==============================================");
		
		Point pt2 = new Point();
		System.out.println("Point pt2 information");
		System.out.println("class name : "+pt2.getClass());
		System.out.println("hash code : "+pt2.hashCode()); // 1651191114
		System.out.println("Object String : " + pt2); // 5e91993f
